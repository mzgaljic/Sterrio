...
static BOOL twoLabelsExistInAlert = NO;

#pragma mark - Mark Zgaljic added feature
+ (BOOL)areTwoLabelsPresentInAlert
{
    return twoLabelsExistInAlert;
}
...
{
    twoLabelsExistInAlert = (title && message);
...
{
    twoLabelsExistInAlert = (attributedTitle && attributedMessage);
...
#pragma mark - Mark Zgaljics additions
