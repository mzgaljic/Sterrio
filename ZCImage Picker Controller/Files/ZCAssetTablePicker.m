...
- (void)doneAction:(id)sender {
    //Mark was here, added this if statement (fixes bug where done was tapped before selection was made)
...
- (void)updateNavigationBarStatus {
    ...
    if (photoSelectCount > 0) {
        ...
        //Mark was here, added second condition in if statement
        if (photoSelectCount <= _maximumAllowsSelectionCount && photoSelectCount > 0) {
